      ...
      <div className={styles.content}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.center} style={{ marginBottom: '50px' }}>
            <h4>Introduction</h4>
            <p>
              We, at Trimsy inc. have prepared a Privacy Policy that aims to help you understand
              what Data we collect, what we use it for and how you can exercise your rights. Our
              Privacy Policy explains how we collect, safeguard and disclose information that
              results from your use of our Service. By using <strong>Service</strong>, you agree to
              ...
              <strong>(“Terms”)</strong> govern all use of our Service and together with the Privacy
              Policy constitutes your agreement with us <strong>(“agreement”)</strong>.
            </p>
          </div>
          <FAQItemEnhanced title={`Types of Data Collected`}>
            ...
            <p>
              ...
              unsubscribe link or by emailing at [how to contact]
            </p>
            <h5>Usage Data</h5>
            <p>
          ...
          <FAQItemEnhanced title={`Use of Data`}>
            <p>
            ...
            <p>
              ...
              research, including profiling and the use of machine learning and other techniques
              over your data and in some cases using third parties to do this.
            </p>
          ...
          <FAQItemEnhanced title={'Analytics'}>
            <p>
            ...
            <p>
              ...
              visited our Service. We and our third-party vendors use cookies to inform, optimize
