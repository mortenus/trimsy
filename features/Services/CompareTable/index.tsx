...
//       <h2 className={'comparing-table-title'}>Which Web is right for your business?</h2>
...
import {
  ...
  EcommerceChild,
  CustomChild,
} from './ServiceChildren';
import ServiceTableItem from './ServiceTableItem/ServiceTableItem';
import { TService, TServiceData } from './CompareTable.types';

const servicesData: TServiceData[] = [
  {
    service: 'Starter',
    href: '/development/services/starter',
    icon: '/static/img/services/product/starter.svg',
    // pricing: 999,
    pricing: 499,
  ...
  {
    service: 'Basic',
    href: '/development/services/basic',
    icon: '/static/img/services/product/basic.svg',
    // pricing: 2500,
    pricing: 1500,
    children: BasicChild,
  },
  {
    ...
    icon: '/static/img/services/product/advanced.svg',
    // pricing: 3500,
    pricing: 2500,
  ...
  },
  {
    ...
    icon: '/static/img/services/product/ecommerce.svg',
    // pricing: 7000,
    pricing: 4000,
    children: EcommerceChild,
  },
  {
    service: 'Custom',
    href: '/development/services/custom',
    icon: '/static/img/services/product/custom.svg',
    pricing: null,
    children: CustomChild,
  },
];

const CompareTable = ({ currentActive }: TService) => {
  return (
    <section className={styles.which}>
      <h2 className={'comparing-table-title'}>Which Web is right for your business?</h2>
      <div className={styles[`compare-grid`]}>
        {servicesData &&
          servicesData.map((service, index) => ServiceTableItem({ ...service, currentActive }))}
      </div>
    </section>
  );
};
...
//       service: 'Starter',
//       href: '/development/services/starter',
//       icon: '/static/img/services/product/eCommerce.png',
//       pricing: 7000,
//       children: StarterChild,
//     },
//     {
//       service: 'Advanced',
//       href: '/development/services/advanced',
//       icon: '/static/img/services/product/advanced.png',
//       pricing: 7000,
//       children: BasicChild,
//     },
//     {
...
//     //   type: 'Custom',
//     //   href: '/development/services/custom',
//     //   icon: '/static/img/services/custom.png',
